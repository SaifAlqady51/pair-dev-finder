...
export const Video: React.FC<VideoProps> = ({ roomId, username, userId }) => {
  ...
  return (
    <div className=" relative w-full h-[calc(100vh-110px)] md:p-8 p-2 md:mx-12 bg-secondary m-4 rounded-[20px] ">
      ...
      <video
        className="absolute md:bottom-12 md:top-auto md:right-12 top-4 right-4 md:w-1/4 w-1/2 h-52 dark:bg-slate-800 bg-slate-400 col-span-2 rounded-[20px] drop-shadow-lg object-cover aspect-video"
        autoPlay
        muted
        ref={partnerVideo}
      />
